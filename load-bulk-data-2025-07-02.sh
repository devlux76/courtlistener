...
echo "Loading schema to database: schema-2025-07-02.sql"
psql -f "$BULK_DIR"/schema-2025-07-02.sql --host "$BULK_DB_HOST" --username "$BULK_DB_USER"

echo "Loading people-db-people-2025-07-02.csv to database"
psql --command "\COPY public.people_db_person (
	   ...
	   ) FROM '$BULK_DIR/people-db-people-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people_db_race-2025-07-02.csv to database"
psql --command "\COPY public.people_db_race (id, race) FROM '$BULK_DIR/people_db_race-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people-db-schools-2025-07-02.csv to database"
psql --command "\COPY public.people_db_school (
	       id, date_created, date_modified, name, ein, is_alias_of_id
	   ) FROM '$BULK_DIR/people-db-schools-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading courts-2025-07-02.csv to database"
psql --command "\COPY public.search_court (
	       ...
	       ) FROM '$BULK_DIR/courts-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people-db-positions-2025-07-02.csv to database"
psql --command "\COPY public.people_db_position (
	       ...
	       supervisor_id
	   ) FROM '$BULK_DIR/people-db-positions-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading fjc-integrated-database-2025-07-02.csv to database"
psql --command "\COPY public.recap_fjcintegrateddatabase (
	   ...
	   ) FROM '$BULK_DIR/fjc-integrated-database-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading originating-court-information-2025-07-02.csv to database"
psql --command "\COPY public.search_originatingcourtinformation (
	       ...
	       ordering_judge_id
	       ) FROM '$BULK_DIR/originating-court-information-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading dockets-2025-07-02.csv to database"
psql --command "\COPY public.search_docket (id, date_created, date_modified, source, appeal_from_str,
	       ...
	       ) FROM '$BULK_DIR/dockets-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading opinion-clusters-2025-07-02.csv to database"
psql --command "\COPY public.search_opinioncluster (
   ...
   ) FROM '$BULK_DIR/opinion-clusters-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading search_opinioncluster_panel-2025-07-02.csv to database"
psql --command "\COPY public.search_opinioncluster_panel (
	       id, opinioncluster_id, person_id
	   ) FROM '$BULK_DIR/search_opinioncluster_panel-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading search_opinioncluster_non_participating_judges-2025-07-02.csv to database"
psql --command "\COPY public.search_opinioncluster_non_participating_judges (
	       id, opinioncluster_id, person_id
	   ) FROM '$BULK_DIR/search_opinioncluster_non_participating_judges-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading opinions-2025-07-02.csv to database"
psql --command "\COPY public.search_opinion (
	   ...
	   ) FROM '$BULK_DIR/opinions-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading search_opinion_joined_by-2025-07-02.csv to database"
psql --command "\COPY public.search_opinion_joined_by (
			id, opinion_id, person_id
) FROM '$BULK_DIR/search_opinion_joined_by-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading courthouses-2025-07-02.csv to database"
psql --command "\COPY public.search_courthouse (id, court_seat, building_name, address1, address2, city, county,
state, zip_code, country_code, court_id) FROM '$BULK_DIR/courthouses-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading court-appeals-to-2025-07-02.csv to database"
psql --command "\COPY public.search_court_appeals_to (id, from_court_id, to_court_id) FROM '$BULK_DIR/court-appeals-to-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading citation-map-2025-07-02.csv to database"
psql --command "\COPY public.search_opinionscited (
	       id, depth, cited_opinion_id, citing_opinion_id
	   ) FROM '$BULK_DIR/citation-map-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading citations-2025-07-02.csv to database"
psql --command "\COPY public.search_citation (
	       id, volume, reporter, page, type, cluster_id
	   ) FROM '$BULK_DIR/citations-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading parentheticals-2025-07-02.csv to database"
psql --command "\COPY public.search_parenthetical (
	       id, text, score, described_opinion_id, describing_opinion_id, group_id
	   ) FROM '$BULK_DIR/parentheticals-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading oral-arguments-2025-07-02.csv to database"
psql --command "\COPY public.audio_audio (
	   ...
	   ) FROM '$BULK_DIR/oral-arguments-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people-db-retention-events-2025-07-02.csv to database"
psql --command "\COPY public.people_db_retentionevent (
	       ...
	       won, position_id
	   ) FROM '$BULK_DIR/people-db-retention-events-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people-db-educations-2025-07-02.csv to database"
psql --command "\COPY public.people_db_education (
	   ...
	   ) FROM '$BULK_DIR/people-db-educations-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people-db-political-affiliations-2025-07-02.csv to database"
psql --command "\COPY public.people_db_politicalaffiliation (
	   ...
	   ) FROM '$BULK_DIR/people-db-political-affiliations-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people-db-races-2025-07-02.csv to database"
psql --command "\COPY public.people_db_person_race (
	       id, person_id, race_id
	   ) FROM '$BULK_DIR/people-db-races-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-2025-07-02.csv to database"
psql --command "\COPY public.disclosures_financialdisclosure (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosures-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosure-investments-2025-07-02.csv to database"
psql --command "\COPY public.disclosures_investment (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosure-investments-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-positions-2025-07-02.csv to database"
psql --command "\COPY public.disclosures_position (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosures-positions-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-agreements-2025-07-02.csv to database"
psql --command "\COPY public.disclosures_agreement (
	       id, date_created, date_modified, date_raw, parties_and_terms,
	       redacted, financial_disclosure_id
	   ) FROM '$BULK_DIR/financial-disclosures-agreements-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-non-investment-income-2025-07-02.csv to database"
psql --command "\COPY public.disclosures_noninvestmentincome (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosures-non-investment-income-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-spousal-income-2025-07-02.csv to database"
psql --command "\COPY public.disclosures_spouseincome (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosures-spousal-income-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-reimbursements-2025-07-02.csv to database"
psql --command "\COPY public.disclosures_reimbursement (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosures-reimbursements-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-gifts-2025-07-02.csv to database"
psql --command "\COPY public.disclosures_gift (
	       id, date_created, date_modified, source, description, value,
	       redacted, financial_disclosure_id
	   ) FROM '$BULK_DIR/financial-disclosures-gifts-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-debts-2025-07-02.csv to database"
psql --command "\COPY public.disclosures_debt (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosures-debts-2025-07-02.csv' WITH (FORMAT csv, ENCODING utf8, ESCAPE '\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"
